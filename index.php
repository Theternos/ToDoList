...
<body>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content mt-5">
                                        ...
                                        <div class="tab-pane" id="tab-animated1-0" role="tabpanel">
                                            ...
                                            <form class="col-md-6 offset-md-3" method="post" action="index.php">
    ...
    <div class="modeledit">
        <div class="modelformedit">
            ...
            <a href="index.php?edit=taskclose">
        ...
        $(document).on('click', '.save', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == 1) {
                        location.reload();
                        window.location.replace("index.php?complet-success");
                        $("#model").hide(800);
                    }
                    if (data == 0) {
                        alert("data not add")
